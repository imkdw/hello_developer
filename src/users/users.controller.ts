...
export class UsersController {
   ...
   */
  @ApiProfileImage('사용자의 프로필 사진을 변경하는 API')
  @HttpCode(200)
  @UseGuards(JwtAuthGuard)
   ...
   * @returns
   */
  @ApiExitUserVerify('회원탈퇴 전 유저검증 API')
  @HttpCode(200)
  @UseGuards(JwtAuthGuard)
  @Patch(':userId/verify')
